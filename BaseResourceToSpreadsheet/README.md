...
4# ArchetypeToSpreadsheet

Convert openEHR archetypes from CKM XML into a mapping-friendly Excel overview. Batch convert a curated list of openEHR archetypes to Excel and mix in a template with ArchetypeBatchConvertWithTemplate.py. 