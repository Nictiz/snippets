...
> 
will launch the targets defined by index number 3, index number 6, and mnemonic "dev.eOvderdrach4.Cert". When launching loadscripts, it will stall until execution has finished.
